    ...
    >
      GitHub
        ...
        <div className="bg-white p-6 rounded-xl shadow mt-6">
          ...
          <p className="mt-3 text-gray-600">
            An AI-powered voice project management application built for the
            ArchScale Guild Intern Technology Hackathon (AS-03). It allows users
            to create, assign, complete and manage project tasks using natural
          ...
          <div className="mt-5 flex gap-4 flex-wrap">
            <a
              href="https://archscale-as03-voice-project.vercel.app/"
              target="_blank"
              rel="noopener noreferrer"
              className="px-4 py-2 bg-blue-600 text-white rounded-lg"
            >
            ...
            <a
              href="https://github.com/ayushi-baliyan/archscale-as03-voice-project"
              target="_blank"
              rel="noopener noreferrer"
              className="px-4 py-2 border rounded-lg"
            >
